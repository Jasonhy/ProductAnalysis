# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-07-17 05:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_title', models.CharField(max_length=64, verbose_name='产品名称')),
                ...
                ('p_c_time', models.CharField(blank=True, max_length=256, null=True, verbose_name='产品评论日期')),
                ('p_price_trend', models.CharField(blank=True, max_length=128, null=True, verbose_name='价格趋势')),
            ],
            options={
